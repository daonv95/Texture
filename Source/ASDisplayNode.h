...
@property (nonatomic, nullable, readonly) id placeholderParameters;
@property (nonatomic, nullable, readonly) ASPlaceholderImageBlock placeholderImageBlock;

- (void)setPlaceholderImageBlock:(_Nullable ASPlaceholderImageBlock)placeholderImageBlock
